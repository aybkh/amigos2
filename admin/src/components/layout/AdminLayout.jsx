  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 md:ml-60 flex flex-col">
        ...
        <header
          className="md:hidden fixed top-0 inset-x-0 z-30 flex items-center gap-3 px-4 py-3 bg-white border-b border-gray-200"
        ...
        {/* Spacer para compensar el header móvil fijo (h-14 = 56px) */}
        <div className="md:hidden h-14" style={{ height: 'calc(3.5rem + env(safe-area-inset-top))' }} aria-hidden="true" />
