  ...
  return (
    <footer className="footer-mobile">
      <div className="footer-mobile-container">
        ...
        <p className="footer-mobile-tagline">{t(lang, 'ui.footer.tagline')}</p>
        <p className="footer-mobile-location">Lloret de Mar</p>
        ...
        <div className="footer-mobile-legal">
          {legalLinks.map(({ labelKey, modal }) => (
            <button key={modal} type="button" onClick={() => openLegal(modal)}>
              {t(lang, labelKey)}
            </button>
          ))}
        </div>

        <p className="footer-mobile-copyright">© 2026 Amigos2 · Lloret de Mar</p>
        <p className="footer-mobile-credits">
