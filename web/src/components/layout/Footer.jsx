...
// Botón social — si no hay href, atenuado (URL aún sin configurar en /admin)
      ...
      <div className="footer-container">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-column">
            <img src="/amigos2-logo-2-1.png" alt="Amigos2" className="footer-logo" />
            <p className="footer-tagline">{t(lang, 'ui.footer.tagline')}</p>
            <p className="footer-location">Lloret de Mar</p>
          </div>

          {/* Col 2 — Navegación */}
          <div className="footer-column">
            <h3 className="footer-column-title">{t(lang, 'ui.footer.nav_title')}</h3>
          ...
          {/* Col 3 — Horarios */}
          <div className="footer-column">
            <h3 className="footer-column-title">{t(lang, 'ui.hours.title')}</h3>
            <p className="footer-hours">
              {t(lang, 'ui.hours.days.lun')} – {t(lang, 'ui.hours.days.dom')}
            </p>
            <p className="footer-hours-time">12:30 – 23:59</p>
            <p className="footer-hours-time">00:00 – 03:00</p>
          </div>

          {/* Col 4 — Contacto + Redes */}
          <div className="footer-column">
            <h3 className="footer-column-title">{t(lang, 'ui.contact.title')}</h3>
            <div className="footer-contact-info">
              {phone && (
                <a href={`tel:${phoneDigits}`} className="footer-contact-link">
                  <Phone size={14} /> {phone}
                </a>
              )}
              {email && (
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-legal">
            {legalLinks.map(({ labelKey, modal }, i, arr) => (
              <span key={modal} className="footer-legal-item">
                <button type="button" onClick={() => openLegal(modal)}>
                  {t(lang, labelKey)}
                </button>
                {i < arr.length - 1 && <span className="footer-legal-sep">·</span>}
              </span>
            ))}
          </div>
